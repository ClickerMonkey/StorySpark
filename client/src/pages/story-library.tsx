    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/">
                <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium" data-testid="button-create-new">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-gray-900">My Story Library</h2>
          <Link href="/">
            <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium" data-testid="button-create-story">
              <Plus className="mr-2 h-4 w-4" />
              Create New Story
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {stories?.map((story) => (
            <Card key={story.id} className="overflow-hidden hover:shadow-xl transition-shadow cursor-pointer">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2" data-testid={`story-title-${story.id}`}>{story.title}</h3>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                  ...
                  <span><Calendar className="inline mr-1" size={14} />{formatDate(new Date(story.createdAt))}</span>
                </div>
          ...
          {/* Add New Story Card */}
          <Link href="/">
            <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-dashed border-purple-300 hover:border-purple-400 transition-colors cursor-pointer h-full">
              <CardContent className="p-6 h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-600 text-sm">Start a magical new adventure!</p>
              </CardContent>
            </Card>
          </Link>
        </div>
